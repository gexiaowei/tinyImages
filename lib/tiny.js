...
var apiKeysRelativePath = '../apikeys.json';
var apiKeysPath = path.join(__dirname, apiKeysRelativePath);
var apiKeys = require(apiKeysRelativePath);
        ...
        if (this.apiKey) {
            ...
            async.whilst(()=> {
                    ...
                    if (this.apiKey) {
                        ...
                        deferred.reject('No api keys is Validate Use -a to add new api key');
                    }
                }
            );
        }
